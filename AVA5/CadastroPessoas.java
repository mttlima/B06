...
class CadastroPessoasCustomizado extends CadastroPessoas {

    public CadastroPessoasCustomizado(JFrame principal) {
        super(principal);
    }

    @Override
    public void exibir() {
        JDialog dialog = new JDialog(principal, "Cadastro de Pessoas Customizado", true);
        dialog.setSize(600, 300);
        dialog.setLayout(new BorderLayout());

        JLabel titulo = new JLabel("Cadastro de Pessoas Customizado", SwingConstants.CENTER);
        dialog.add(titulo, BorderLayout.NORTH);
