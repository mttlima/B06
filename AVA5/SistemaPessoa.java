...
class SistemaPessoaCustomizado extends SistemaPessoa {

    @Override
    public void iniciarSistema() {
        JFrame principal = new JFrame("Sistema Pessoa Customizado");
        principal.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        principal.setSize(800, 800);

        JMenuBar menuPrincipal = new JMenuBar();
        JMenu menuCadastro = new JMenu("Cadastro Customizado");
        JMenu menuVisualizacao = new JMenu("Visualização Customizada");
        JMenu menuSair = new JMenu("Sair Customizado");
        ...
        JMenuItem itemMenuCadastroUsuarios = new JMenuItem("Usuários Customizados");
        JMenuItem itemMenuCadastroPessoas = new JMenuItem("Pessoas Customizadas");
        menuCadastro.add(itemMenuCadastroUsuarios);
        menuCadastro.add(itemMenuCadastroPessoas);

        JMenuItem itemMenuVisualizacaoListaUsuarios = new JMenuItem("Lista de usuários Customizados");
        JMenuItem itemMenuVisualizacaoListaPessoas = new JMenuItem("Lista de pessoas Customizadas");
        menuVisualizacao.add(itemMenuVisualizacaoListaUsuarios);
        menuVisualizacao.add(itemMenuVisualizacaoListaPessoas);
